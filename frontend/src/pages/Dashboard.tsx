...
import { Music, HardDrive, PlayCircle, Play, FileText, Calendar, Clock, AlertCircle, ListPlus } from 'lucide-react';
...
export default function Dashboard() {
  const { user } = useAuth();
  const { isConnected, connect, disconnect, client, isReconnecting, handleReconnect } = useDropbox();
  ...
  return (
    <Box>
      ...
      <Grid container spacing={3} sx={{ mt: 2 }}>
        ...
        {isConnected && (
          <>
            ...
            <Grid item xs={12}>
              <PlaylistManager onPlaylistSelect={() => {}} />
            </Grid>
          </>
        )}
      </Grid>
      ...
      <Dialog open={errorDialogOpen} onClose={() => setErrorDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Lost connection to Dropbox. Would you like to try reconnecting?
          </Typography>
        </DialogContent>
        <DialogActions>
